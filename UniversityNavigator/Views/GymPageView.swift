                ...
                VStack(spacing: 25) {
                    ...
                    // region card view
                                        VStack(spacing: 0) {
                                            ...
                                            ZStack {
                                                AsyncImage(url: URL(string: "your_gym_image_url")) { image in
                                                    image
                                                        .resizable()
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        VStack(spacing: 15) {
                            HStack(spacing: 15) {
                                FacilityCard(icon: "drop", title: "Showers", color: .blue)
                                FacilityCard(icon: "cabinet", title: "Lockers", color: .blue)
                            }
                            
                            HStack(spacing: 15) {
                                FacilityCard(icon: "dumbbell", title: "Weights", color: .blue)
                                FacilityCard(icon: "figure.run", title: "Treadmills", color: .blue)
                            }
                        }
                        .padding(.horizontal, 20)
                    }
                    ...
                    VStack(alignment: .leading, spacing: 15) {
                        ...
                        VStack(alignment: .leading, spacing: 12) {
                            ...
                            HStack {
                                TextField("Type your email to get the application", text: $emailText)
                                    .font(.system(size: 14))
